...
// ФУНКЦИЯ КОТОРАЯ ОПРЕДЕЛЯЕТ КОЛИЧЕСТОВ СИМВОЛОВ В ТЕКСТЕ СТАТЬИ 
// И ВЫВОДИТ ВРЕМЯ ДЛЯ ЕЕ ПРОЧТЕНИЯ 

// ОНА ВЫЗЫВАЕТСЯ В ФАЙЛЕ START-API.JS КОГДА МЫ УВИДЕЛИ НА СТРАНИЦЕ АЙДИШНИК АРТ ТЕКСТ 
